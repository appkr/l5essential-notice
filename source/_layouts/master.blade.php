...
<head>
  ...
  <meta name="description" content="{{ ($current_url != '/') ? $lessons[$current_index]['description'] : $site_description}}"/>
  ...
  <!-- Facebook Meta -->
  <meta property="og:title" content="{{ $site_title }}{{ ($current_url != '/') ? '::'.$lessons[$current_index]['title'] : '' }}"/>
  <meta property="og:type" content="Website"/>
  <meta property="og:author" content="appkr (juwonkim@me.com)"/>
  <meta property="og:image" content=""/>

  <!-- Google+ Meta -->
  <meta itemprop="name" content="{{ $site_title }}{{ ($current_url != '/') ? '::'.$lessons[$current_index]['title'] : '' }}">
  <meta itemprop="description" content="{{ ($current_url != '/') ? $lessons[$current_index]['description'] : ''}}">
  ...
  <meta name="twitter:title" content="{{ $site_title }}{{ ($current_url != '/') ? ': '.$lessons[$current_index]['title'] : '' }}"/>
  <meta name="twitter:description" content="{{ ($current_url != '/') ? $lessons[$current_index]['description'] : ''}}"/>
  ...
  <title>{{ $site_title }}{{ ($current_url != '/') ? '::'.$lessons[$current_index]['title'] : '' }}</title>

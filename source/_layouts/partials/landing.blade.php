...
<p>이 온라인 강좌는 2016년 11월에 종이책으로 출간했다. 큰 흐름은 이 온라인 강좌와 비슷하지만, 종이책은 라라벨 5.3을 기준으로 설명하며, 프로들의 도움을 받아 문장을 정제하고 설명이 부족한 부분을 보충했다. PHP 문법이나 객체 지향의 개념을 포함했다거나, 보우어(bower)대신 npm을 사용하는 등 최신 개발 트렌드에 맞도록 일부 내용은 개정했다. </p>
